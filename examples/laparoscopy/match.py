...
matcher = StereoMatcher(imgL, imgR, method="dynamic_programming", occlusion_penalty=0)
...
# Block Matching
# Running the algorithm
matcher = StereoMatcher(imgL, imgR, method="block_matching", disparity_range=16, var_threshold=2, min_block_size=5, max_block_size=5)
